  ...
  return (
    <div className="w-full bg-white/90 backdrop-blur-2xl border border-blue-100/90 rounded-3xl p-4 sm:p-6 shadow-[0_15px_40px_rgba(30,58,138,0.06)] relative overflow-hidden transition-all duration-200">
      ...
      {showAnswer && fullQuestion.correctAnswer && (
        <div className="mt-4 p-3 rounded-2xl bg-emerald-50 border border-emerald-200 flex items-center gap-2.5 text-emerald-800 shadow-xs relative z-10">
          ...
          <div>
            <span className="text-[9px] font-black uppercase tracking-widest block text-emerald-700/90">
              Host Answer Key
            </span>
