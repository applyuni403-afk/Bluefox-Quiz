      ...
      <form onSubmit={handleJoin} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="BLUFOX"
            className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 font-mono text-2xl font-black tracking-widest text-center uppercase transition-all shadow-2xs"
          />
        </div>
